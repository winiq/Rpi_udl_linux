...
__used __section("__versions") = {
	...
	{ 0x282d73b5, "mipi_dbi_spi_transfer" },
	{ 0x9bc47d72, "mipi_dbi_spi_cmd_max_speed" },
	{ 0xfd389cbc, "gpiod_set_value_cansleep" },
	{ 0x942f0ee9, "drm_dev_printk" },
	{ 0x3bf83a34, "mipi_dbi_hw_reset" },
	{ 0xf9a482f9, "msleep" },
...
MODULE_INFO(depends, "drm,drm_kms_helper,drm_mipi_dbi");
