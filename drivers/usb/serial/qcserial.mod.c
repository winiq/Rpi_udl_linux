...
__used __section("__versions") = {
	...
	{ 0x4b865cf8, "usb_wwan_dtr_rts" },
	{ 0x601c8906, "usb_wwan_tiocmset" },
	{ 0xd69786af, "usb_wwan_tiocmget" },
	{ 0xc5495b82, "usb_wwan_chars_in_buffer" },
	{ 0xcd76b8dd, "usb_wwan_write_room" },
	{ 0xf514cb90, "usb_wwan_write" },
	{ 0x50bb94b0, "usb_wwan_close" },
	{ 0x4abd5a65, "usb_wwan_open" },
	{ 0x56f4d0ad, "usb_wwan_resume" },
	{ 0x703248ba, "usb_wwan_suspend" },
